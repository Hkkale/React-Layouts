...
const Section1 = () => {
  return (
    <section className="h-200  w-full    plus-jakarta-sans-200 flex flex-col justify-center items-center relative gap-7  ">
      <h1
      ...
      <div className="h-123 z-20  w-75 absolute left-88 bottom-0 rotate-13 " style={{boxShadow:' -15px 15px 50px black'}}>
      ...
      <div className="h-123 z-20 w-75 absolute right-89  -rotate-19 " style={{boxShadow:' -15px 0px 50px black'}}>
        <div className="h-3/5 w-full purple-background"></div>
