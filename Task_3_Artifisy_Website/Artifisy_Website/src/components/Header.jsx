...
const Header = () => {
  return (
    <header className='h-12 mt-5 w-full    text-white'>
      <nav className='h-full w-full flex flex-row justify-between plus-jakarta-sans-200'>
        ...
        <div className='w-4/11 h-full flex flex-row    items-center justify-between mr-18 plus-jakarta-sans-300 '>
          <h2 className='text-sm '>ABOUT</h2>
          <h2 className='text-sm'>WORK</h2>
          <h2 className='text-sm  '>PORTFOLIO</h2>
          <h2 className='text-sm  border rounded-2xl px-6 py-1.5'>CONTACT</h2>
        </div>
